...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option1 = (Button) findViewById(R.id.guess1);
        option2 = (Button) findViewById(R.id.guess2);
        option3 = (Button) findViewById(R.id.guess3);
        option4 = (Button) findViewById(R.id.guess4);
